...
#define ATTACK_HOME     0x4000UL  //ATTACK_HOME = ATTACK_GUIDE
#define ATTACK_SELECT   0x2000UL  //ATTACK_SELECT = ATTACK_BACK
#define ATTACK_START    0x1000UL  //0x8000UL could potentially be the starting binary pin
