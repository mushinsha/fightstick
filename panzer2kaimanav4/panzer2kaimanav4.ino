...
void setLEDRandomColor(int index)
{
  switch(random(1,14))    // pick a random color between 1 and 14
  {
    case 1:
    ...
    case 9:
      ...
      break;
    case 10:
      kaimana.setLED(index, COLOR_RANDOM_10);
      break;
    case 11:
      kaimana.setLED(index, COLOR_RANDOM_11);
      break;
    case 12:
      kaimana.setLED(index, COLOR_RANDOM_12);
      break;
    case 13:
      kaimana.setLED(index, COLOR_RANDOM_13);
      break;
    case 14:
      kaimana.setLED(index, COLOR_RANDOM_14);
      break;
...
int pollSwitches(void)
{
  ...
  // combo #2 - test for: Ryu Shoryuken (Dragon Punch)
  ...
  // combo #1 - test for: Ryu Hadouken (Fireball)  
...
// X-Factor Combo Animation
 ...
 // Idle Test Animation
 if( kaimana.switchHistoryTest( IDLE_PATTERN ) )
      animation_test();
