...
void animation_xfactor(void);      // xfactor
void animation_redsnake(void);     // red snake animation
void animation_bootup(void);       // bootup animation that looks like a cockpit lighting up
void animation_vshape(void);       // Viewtiful BABY!
void animation_test(void);         // Using the Idle animation stuff
