...
//
// THIS FILE GENERATED ON: Thursday 10th of September 2020 05:31:08 PM
...
//ON BUTTON STATE - RANDOM
#define RANDOM_COLOR_LEFT_ON
#define RANDOM_COLOR_DOWN_ON
#define RANDOM_COLOR_RIGHT_ON
#define RANDOM_COLOR_UP_ON
#define RANDOM_COLOR_P1_ON
#define RANDOM_COLOR_P2_ON
#define RANDOM_COLOR_P3_ON
#define RANDOM_COLOR_P4_ON
#define RANDOM_COLOR_K1_ON
#define RANDOM_COLOR_K2_ON
#define RANDOM_COLOR_K3_ON
#define RANDOM_COLOR_K4_ON
#define RANDOM_COLOR_SELECT_ON
#define RANDOM_COLOR_HOME_ON
#define RANDOM_COLOR_START_ON
...
//#define LED_LEFT_COLOR_ON    255,255,255 // WHITE
//#define LED_DOWN_COLOR_ON    255,255,255 // WHITE
//#define LED_RIGHT_COLOR_ON   255,255,255 // WHITE
//#define LED_UP_COLOR_ON      255,255,255 // WHITE
//#define LED_P1_COLOR_ON      0,0,255     // BLUE
//#define LED_P2_COLOR_ON      255,255,0   // YELLOW
//#define LED_P3_COLOR_ON      255,0,0     // RED
//#define LED_P4_COLOR_ON      255,255,255 // WHITE
//#define LED_K1_COLOR_ON      0,0,255     // BLUE
//#define LED_K2_COLOR_ON      255,255,0   // YELLOW
//#define LED_K3_COLOR_ON      255,0,0     // RED
//#define LED_K4_COLOR_ON      255,255,255 // WHITE
//#define LED_SELECT_COLOR_ON  000,000,000
//#define LED_HOME_COLOR_ON    000,000,000
//#define LED_START_COLOR_ON   000,000,000

//  //OFF BUTTON STATE 
#define LED_LEFT_COLOR_OFF   000,000,000
#define LED_DOWN_COLOR_OFF   000,000,000
#define LED_RIGHT_COLOR_OFF  000,000,000
#define LED_UP_COLOR_OFF     000,000,000
#define LED_P1_COLOR_OFF     000,000,000
#define LED_P2_COLOR_OFF     000,000,000
#define LED_P3_COLOR_OFF     000,000,000
#define LED_P4_COLOR_OFF     000,000,000
#define LED_K1_COLOR_OFF     000,000,000
#define LED_K2_COLOR_OFF     000,000,000
#define LED_K3_COLOR_OFF     000,000,000
#define LED_K4_COLOR_OFF     000,000,000
#define LED_SELECT_COLOR_OFF 000,000,000
#define LED_HOME_COLOR_OFF   000,000,000
#define LED_START_COLOR_OFF  000,000,000

//RANDOM COLORS SET
#define COLOR_RANDOM_1  255,255,255 // WHITE
#define COLOR_RANDOM_2  0,0,255     // BLUE
#define COLOR_RANDOM_3  255,255,0   // YELLOW
#define COLOR_RANDOM_4  220,127,0   // ORANGE
#define COLOR_RANDOM_5  0,255,255   // CYAN
#define COLOR_RANDOM_6  255,0,255   // MAGENTA
#define COLOR_RANDOM_7  127,255,0   // GREEN
#define COLOR_RANDOM_8  220,0,127   // PINK
#define COLOR_RANDOM_9  146,0,219   // PURPLE
#define COLOR_RANDOM_10 178,34,34   // FIREBRICK
#define COLOR_RANDOM_11 255,0,0     // RED
#define COLOR_RANDOM_12 255,215,0   // GOLD
#define COLOR_RANDOM_13 245,245,220 // BEIGE
#define COLOR_RANDOM_14 152,251,152 // PALEGREEN
...
#define  IDLE_ANIMATION_DELAY     2.5    // value in miliseconds - use smaller value for faster idle animation playback
#define  BRIGHTNESS                 1
...
#define  XFACTOR_PATTERN       ATTACK_K1 + ATTACK_P2 + ATTACK_K3
#define  COMBO_PATTERN_7A      ATTACK_P2 + ATTACK_P1 + ATTACK_LEFT, ATTACK_LEFT, ATTACK_LEFT + ATTACK_DOWN, ATTACK_DOWN
#define  COMBO_PATTERN_7B      ATTACK_P2 + ATTACK_P1 + ATTACK_RIGHT, ATTACK_RIGHT , ATTACK_RIGHT + ATTACK_DOWN, ATTACK_DOWN
#define  COMBO_PATTERN_8A      ATTACK_P2 + ATTACK_P1 + ATTACK_LEFT + ATTACK_DOWN, ATTACK_LEFT + ATTACK_DOWN, ATTACK_DOWN, ATTACK_NONE, ATTACK_LEFT
#define  COMBO_PATTERN_8B      ATTACK_P2 + ATTACK_P1 + ATTACK_RIGHT + ATTACK_DOWN, ATTACK_RIGHT + ATTACK_DOWN, ATTACK_DOWN, ATTACK_NONE, ATTACK_RIGHT
#define  REDSNAKE_PATTERN      ATTACK_P1 + ATTACK_K4
#define  BOOTUP_PATTERN        ATTACK_P1 + ATTACK_P4 + ATTACK_K1 + ATTACK_K4
#define  VSHAPE_PATTERN        ATTACK_P1 + ATTACK_K2 + ATTACK_P3
#define  IDLE_PATTERN          ATTACK_P1 + ATTACK_P4 + ATTACK_K4
