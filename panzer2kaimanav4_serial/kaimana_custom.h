...
//OFF BUTTON STATE 
#define LED_LEFT_COLOR_OFF 255,000,000
#define LED_DOWN_COLOR_OFF 255,000,000
#define LED_RIGHT_COLOR_OFF 255,000,000
#define LED_UP_COLOR_OFF 255,000,000
#define LED_P1_COLOR_OFF 000,220,220
#define LED_P2_COLOR_OFF 000,220,220
#define LED_P3_COLOR_OFF 000,220,220
#define LED_P4_COLOR_OFF 000,220,220
#define LED_K1_COLOR_OFF 000,220,220
#define LED_K2_COLOR_OFF 000,220,220
#define LED_K3_COLOR_OFF 000,220,220
#define LED_K4_COLOR_OFF 000,220,220
#define LED_SELECT_COLOR_OFF 0,0,0
#define LED_HOME_COLOR_OFF 0,0,0
#define LED_START_COLOR_OFF 0,0,0

//RANDOM COLORS SET
#define COLOR_RANDOM_1 255,255,255
#define COLOR_RANDOM_2 0,0,255
#define COLOR_RANDOM_3 255,255,0
#define COLOR_RANDOM_4 220,127,0
#define COLOR_RANDOM_5 0,255,255
#define COLOR_RANDOM_6 255,0,255
#define COLOR_RANDOM_7 127,255,0
#define COLOR_RANDOM_8 220,0,127
...
#define  IDLE_TIMEOUT_SECONDS      15    // value in seconds - normally 60 or 30 seconds but set very short for testing
...
//
#define  COMBO_PATTERN_1A    ATTACK_RIGHT + ATTACK_P1, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN
...
#define  XFACTOR_PATTERN     ATTACK_P1 + ATTACK_P2 + ATTACK_P3 + ATTACK_K1
...
#define  REDSNAKE_PATTERN    ATTACK_K1 + ATTACK_K2 + ATTACK_K3 + ATTACK_K4
#define  BLUESNAKE_PATTERN   ATTACK_P1 + ATTACK_P2 + ATTACK_P3 + ATTACK_P4
#define  BOOTUP_PATTERN      ATTACK_P3 + ATTACK_P4 + ATTACK_K3 + ATTACK_K4
