...
//blue snake that wipes from left to right twice, first time trailing white, second time trailing black
void animation_bluesnake(void)
{
  kaimana.setALL( BLUE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setALL( BLACK );
  delay( 90 );
  kaimana.setLED ( LED_LEFT_B, BLUE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_LEFT, WHITE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_DOWN_B, BLUE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_DOWN, WHITE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_RIGHT_B, BLUE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_RIGHT, WHITE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_UP_B, BLUE );
  delay( 90 );
  kaimana.updateALL();
  kaimana.setLED ( LED_UP, WHITE );
  delay( 90 );
